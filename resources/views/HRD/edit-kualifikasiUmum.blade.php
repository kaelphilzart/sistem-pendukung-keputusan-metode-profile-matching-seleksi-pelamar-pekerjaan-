<div class="modal fade" id="edit-kualifikasiUmum{{$dataKualifikasi->id}}" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Kualifikasi Umum</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-dark">
                            <form action="{{ route('update-kualifikasiUmum', ['id' => $dataKualifikasi->id]) }}" method="POST">
                    @csrf
                    <div class="mb-3">
