...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet"
  ...
  <link rel="stylesheet" type="text/css" href="\css/pelamar/icomoon.css">
<link rel="stylesheet" type="text/css" href="\css/pelamar/vendor.css">
<link rel="stylesheet" type="text/css" href="\css/pelamar/styles.css">
<link rel="stylesheet" type="text/css" href="\css/pelamar/normalize.css">
...
<body style="background-color: #08693b;">
@if(session('success'))
...
@endif
  ...
  <nav class="main-menu d-flex navbar navbar-expand-lg p-2 py-3 p-lg-4 py-lg-4 bg-white shadow-sm">
    <div class="container-fluid"> 
      <div class="main-logo d-lg-none">
        <a href="index.html">
          <img src="/img/logo-template.png" alt="logo" class="img-fluid" style="width: 30%;">
        </a>
      </div>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body justify-content-between">
          <div class="main-logo">
            <a href="index.html">
              <img src="img/logo-template.png" alt="logo" class="img-fluid" style="width: 40%;">
            </a>
          </div>

          <ul class="navbar-nav menu-list list-unstyled align-items-lg-left d-flex gap-md-3 mb-0">
            <li class="nav-item">
              <a href="{{route('dashboard_pelamar')}}" class="nav-link mx-2 active">Home</a>
            </li>
            
            <li class="nav-item">
              <a href="{{route('profile-pelamar')}}" class="nav-link mx-2 ">Profile</a>
            </li>
            <li class="nav-item">
              <a href="{{route('lowongan')}}" class="nav-link mx-2 ">Lowongan</a>
            </li>
            <!-- <li class="nav-item">
              <a href="{{route('pengumuman')}}" class="nav-link mx-2 ">Pengumuman</a>
            </li> -->
          ...
          <div class="d-none d-lg-flex align-items-center ">
            <ul class="d-flex  align-items-center list-unstyled m-0 px-4">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle align-items-center" role="button" id="courses"
                data-bs-toggle="dropdown" aria-expanded="false">
                <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px">
                <use href="#user-circle" />
              </svg> </a>{{Auth::user()->name}}</a>
              <ul class="dropdown-menu" aria-labelledby="courses">
                <li><a href="{{route('logout-pelamar')}}" class="dropdown-item">Logout</a></li>
              </ul>
            </li>
