      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  ...
                  <span class="text-dark">{{Auth::user()->role}}</span>
                </div>
              </div>
              <a href="#" id="profile-dropdown" data-toggle="dropdown"><i class="mdi mdi-dots-vertical" style="color:black;"></i></a>
          ...
          <li class="nav-item nav-category">
            <span class="nav-link" style="color:black;">Navigation</span>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('dashboard_pemilik')}}">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('riwayat-seleksi')}}">
              <span class="menu-icon">
                <i class="mdi mdi-playlist-play"></i>
              </span>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    ...
                    <i class="mdi mdi-menu-down d-none d-sm-block" style="color: black;"></i>
                  </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="{{route('logout-pemilik')}}">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
